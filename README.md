...
**Tienda Virtual de Camisetas UNIX** es un proyecto académico desarrollado en **PHP 8 (estilo procedural)** con **MySQL/MariaDB**, usando **Bootstrap 5.3.8** y **JavaScript** en el frontend.
